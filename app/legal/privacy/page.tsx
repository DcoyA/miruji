    ...
    <main style={pageStyle}>
      <div style={containerStyle}>
        ...
        <ul style={listStyle}>
          ...
          <li>
            위치 정보: 미션 인증(완료 확인) 시점에 이용자가 제공에 동의하는 경우, 해당 시점의
            위치 정보를 1회성으로 수집·저장할 수 있습니다.
          </li>
        ...
        <ul style={listStyle}>
          ...
          <li>미션 인증의 신뢰성 확보를 위한 위치 정보 확인(제공에 동의한 경우에 한함)</li>
        ...
        <h2 style={sectionTitleStyle}>6. 위치 정보의 처리</h2>
        <p style={paragraphStyle}>
          서비스는 미션 인증의 정확성을 높이기 위해 이용자가 동의하는 경우에 한해 위치 정보를
          수집할 수 있습니다. 위치 정보는 실시간 추적 목적이 아닌, 미션 인증 시점의 1회성
          확인 목적으로만 수집·저장되며, 이용자는 기기 설정을 통해 위치 정보 제공에 대한 동의를
          언제든지 철회할 수 있습니다. 위치 정보의 구체적인 수집·이용에 관한 사항은 관련 법령
          (「위치정보의 보호 및 이용 등에 관한 법률」)에 따라 별도로 안내될 수 있습니다.
        </p>
