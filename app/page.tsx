  ...
  if (step === "create") {
    return (
      <section style={onboardingBoxStyle}>
        ...
        />
        <button onClick={onCreateWorkspace} disabled={loading} style={onboardingPrimaryButtonStyle(loading)}>
...
const onboardingBoxStyle: CSSProperties = { padding: 20, borderRadius: 22, background: "#f8fafc", border: "1px solid #e2e8f0" };
const onboardingWelcomeTitleStyle: CSSProperties = { margin: "0 0 10px", fontSize: 26, fontWeight: 900, letterSpacing: "-0.03em" };
const onboardingTitleStyle: CSSProperties = { margin: "12px 0 10px", fontSize: 22, fontWeight: 900, letterSpacing: "-0.03em" };
const onboardingTextStyle: CSSProperties = { color: "#64748b", lineHeight: 1.6, marginBottom: 18 };
const onboardingBackButtonStyle: CSSProperties = { border: "none", background: "transparent", color: "#4f46e5", fontWeight: 800, fontSize: 13, cursor: "pointer", padding: 0 };
const onboardingInputStyle: CSSProperties = { width: "100%", padding: 14, borderRadius: 14, border: "1px solid #dbeafe", marginBottom: 12, outline: "none", fontSize: 15, background: "#fff" };
const onboardingMessageStyle: CSSProperties = { marginTop: 14, padding: 12, borderRadius: 14, background: "#eef2ff", color: "#4338ca", fontSize: 13, lineHeight: 1.5 };
...
const onboardingChoiceTitleStyle: CSSProperties = { fontSize: 16, fontWeight: 900, color: "#1e293b" };
...
function onboardingPrimaryButtonStyle(loading: boolean): CSSProperties {
  return { width: "100%", padding: 14, borderRadius: 14, border: "none", background: loading ? "#94a3b8" : "#4f46e5", color: "#fff", fontWeight: 800, cursor: loading ? "not-allowed" : "pointer" };
}
